...
const loginSchema = Yup.object().shape({
  supervisorName: Yup.string()
    ...
    .required("Supervioser name is required"),
  email: Yup.string()
...
export default function SupervisorModal({ showModal, setShowModal }) {
  return (
    <>
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-[538px] my-6 mx-auto max-w-3xl">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none pb-5">
                ...
                <div className="relative px-6 flex-auto">
                  <div>
                    <h1 className="font-medium font-lg">Creating Supervisor</h1>
                        ...
                        <Form>
                          ...
                          <div className="flex justify-between gap-4 py-3">
                            ...
                            >
                              ...
                              <p className="ml-2">Create Supervisor</p>
                            </button>
                          </div>
                        </Form>
                      )}
