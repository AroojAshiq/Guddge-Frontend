    ...
    <section className=" bg-[#29575E]  dark:bg-[#07343A] text-black-600 body-font flex justify-center items-center  ">
      <div className="choose container py-24 px-5 space-y-16 ">
        <div className="flex flex-wrap w-full  mb-8 flex-col items-center">
          <h1 className="xl:text-[45px] text-4xl font-lg font-bold title-font mb-2 text-white ">
          Our Clients
          </h1>
        ...
        <div className="flex flex-wrap   justify-center justify-items-center   grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-col-1 xl:gap-x-10 xl:gap-y-12 lg:gap-x-4 lg:gap-y-20 md:gap-x-6 sm:gap-y-8  ">
       ...
       <div className="xl:w-[300px] xl:h-auto lg:w-[400px] lg:h-auto md:w-[330px] md:h-auto w-[350px] h-auto p-4 mt-8 rounded-lg bg-white-900 text-white  shadow-lg  xl:h-96 md:h-72  bg-[#F5FEFF]  dark:bg-[#04505B] ">
            ...
            <div className="w-full ">
              <h2 className="  text-base font-semibold leading-[20px] text-black dark:text-white  rounded-lg  title-font mb-6 text-center ">
              Bridgestone<br></br> <span className="text-[#444444] dark:text-[#5F8388] text-xs font-normal leading-[16px]"> Client</span>
              </h2>
       ...
       <div className="xl:w-[300px] xl:h-auto lg:w-[400px] lg:h-auto md:w-[330px] md:h-auto w-[350px] h-auto p-4 mt-8 rounded-lg bg-white-900 text-white  shadow-lg  xl:h-96 md:h-72  bg-[#F5FEFF] dark:bg-[#04505B] ">
            ...
            <div className="w-full ">
              <h2 className="  text-base font-semibold leading-[20px]  text-black dark:text-white  rounded-lg  title-font mb-6 text-center ">
              Barclay’s Capital <br></br> <span className="text-[#444444]  dark:text-[#5F8388] text-xs font-normal leading-[16px]"> Client</span>
              </h2>
          ...
          <div className="xl:w-[300px] xl:h-auto lg:w-[400px] lg:h-auto md:w-[330px] md:h-auto w-[350px] h-auto p-4 mt-8 rounded-lg bg-white-900 text-white  shadow-lg xl:h-96 md:h-72  bg-[#F5FEFF] dark:bg-[#04505B] ">
            ...
            <div className="w-full ">
              <h2 className="  text-base font-semibold leading-[20px]  text-black dark:text-white  rounded-lg  title-font mb-6 text-center ">
              Enterprise Products Partners L.P. <br></br> <span className="text-[#444444] dark:text-[#5F8388] text-xs font-normal leading-[16px]"> Company</span>
              </h2>
          ...
          <div className="xl:w-[300px] xl:h-auto lg:w-[400px] lg:h-auto md:w-[330px] md:h-auto w-[350px] h-auto p-4 mt-8 rounded-lg bg-white-900 text-white  shadow-lg xl:h-96 md:h-72  bg-[#F5FEFF] dark:bg-[#04505B] ">
            ...
            <div className="w-full ">
              <h2 className="  text-base font-semibold leading-[20px]  text-black dark:text-white  rounded-lg  title-font mb-6 text-center ">
              Lucent Technologies <br></br> <span className="text-[#444444] dark:text-[#5F8388] text-xs font-normal leading-[16px]"> Client</span>
              </h2>
