...
const SignupForm = () => {
  return (
    <section className="3xl:px-[70px] 2xl:px-[50px] xl:px-[40px] lg:px-[40px] md:px-[40px] px-2 bg-[#F5F5F5] dark:bg-[#04505B] text-black-600 body-font  flex justify-center items-center overflow-hidden  ">
      <div className="container py-24  flex  justify-center items-center    ">
        <div className=" w-full flex justify-center items-center lg:flex-row flex-col space-y-8 3xl:space-x-32 2xl:space-x-2 xl:ml-0 lg:ml-0 md:ml-0  ml-0  ">
          <div className="3xl:w-[1200px] 2xl:w-[1080px] xl:w-[850px] lg:w-[550px] w-full  p-4   mt-8 bg-white dark:bg-[#0E292D] rounded-lg shadow-lg  flex justify-center items-center flex-col  relative overflow-hidden ">
              ...
              {(formik) => (
                ...
                >
                  ...
                  <div className="w-full h-40 p-4 flex justify-center">
                    <div className=" w-full h-full  space-y-2 xl:mt-0 lg:mt-0 md:mt-0 mt-12">
                      <label className="hidden dark:block text-black dark:text-white text-sm font-medium leading-[20px]">
                        {" "}
                        Your Message
                      </label>
          ...
          <div className="lg:w-[450px] lg:h-[625px] md:w-[450px] md:h-[600px] xl:block lg:block md:block hidden  flex justify-center items-center relative  ">
            <img
              alt="gallery"
              className="  h-[625px] object-cover rounded-lg  object-center  mt-7 3xl:ml-6 2xl:ml-5 xl:ml-2 lg:ml-3 md:ml-0 ml-0 "
              src="./help-desk.svg"
            />
          </div>
        </div>
