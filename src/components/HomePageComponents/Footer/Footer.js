...
function Footer() {
  return (
    <div>
      <footer className="w-full p-16 bg-[#595959] dark:bg-[#022125] relative z-0 ">
        <div className=" lg:w-44  lg:h-40 md:w-44 lg:h-40 w-32 h-32 absolute  xl:left-[1095px] xl:top-44 lg:left-[800px] lg:top-[190px] md:left-[570px] md:top-[390px]  left-[230px] top-28  z-10  ">
          <img
            alt="gallery"
        ...
        <div className=" lg:w-96  lg:h-40 md:w-80 md:h-36 w-64 h-28 absolute xl:left-[400px] xl:top-40  lg:left-[350px] lg:top-[190px] md:left-[200px] md:top-[370px] left-[100px] top-[830px]  z-10 ">
          <img
            alt="gallery"
            className=" object-cover h-full  object-center block"
            src="./footer-3.svg"
        ...
        <div className=" w-16 xl:top-[224px] -left-[0.5px] lg:top-[220px] md:top-[410px] top-[840px] absolute  z-10 ">
          <img
            alt="gallery"
        ...
        <div className="w-full h-auto relative z-20  ">
          <div className="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-2 sm:grid-col-1 xl:gap-28 lg:gap-32 md:gap-16 gap-y-12">
            <div className="xl:w-64 lg:w-60 ">
              ...
              <div className="flex mt-8 sm:justify-start space-x-4  ">
                <Link
                  to="/"
